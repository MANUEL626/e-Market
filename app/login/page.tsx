...
import { LayoutGrid, Mail, Lock, CheckCircle, X } from "lucide-react";
      ...
      <div className="flex flex-col items-center w-full max-w-[420px]">
        ...
        <div className="bg-white p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] w-full border border-gray-100">
          <form className="space-y-5" onSubmit={handleLogin}>
            ...
            <button
              type="submit"
              className="w-full py-3 px-4 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-xl transition-colors shadow-sm mt-2"
            >
              Log In
            </button>
          </form>
          ...
          <div className="mt-8">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button className="flex items-center justify-center gap-2 px-4 py-2.5 border border-gray-100 bg-gray-50/50 hover:bg-gray-100 rounded-xl text-sm font-semibold text-gray-700 transition lg:px-6">
              ...
              <button className="flex items-center justify-center gap-2 px-4 py-2.5 border border-gray-100 bg-gray-50/50 hover:bg-gray-100 rounded-xl text-sm font-semibold text-gray-700 transition">
        ...
        <p className="mt-8 text-sm text-gray-600">
          Don't have an account? <Link href="/register" className="font-bold text-indigo-700 hover:text-indigo-800">Get Started</Link>
        </p>

        {/* Bottom Small Footer */}
        <div className="mt-16 text-center">
           <div className="flex gap-4 justify-center text-[10px] font-bold tracking-widest text-gray-500 mb-4">
              <Link href="#" className="hover:text-gray-800">STATUS</Link>
           ...
           <div className="text-[10px] text-gray-400">
              © 2024 Indigo Marketplace. All rights reserved.
           </div>
        </div>
      </div>
